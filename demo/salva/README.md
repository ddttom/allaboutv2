...
**Live Demo:** <https://allabout.network/demo/salva/>
...
- **Spanish version:** `/demo/salva/es/index.html` (default)
- **English version:** `/demo/salva/en/index.html`
- **Root redirect:** `/demo/salva/index.html` detects browser language
...
```html
<link rel="alternate" hreflang="es" href="https://allabout.network/demo/salva/es/index.html" />
<link rel="alternate" hreflang="en" href="https://allabout.network/demo/salva/en/index.html" />
<link rel="alternate" hreflang="x-default" href="https://allabout.network/demo/salva/es/index.html" />
```
...
1. **Direct access:** Open `/demo/salva/` in a browser
...
curl -I https://allabout.network/demo/salva/es/index.html

# Check sitemap
curl https://allabout.network/demo/salva/sitemap.xml

# Test language detection redirect
curl -L https://allabout.network/demo/salva/

# Test with specific Accept-Language header
curl -H "Accept-Language: en-US,en;q=0.9" -L https://allabout.network/demo/salva/
```
