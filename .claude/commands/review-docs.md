...
**Documentation Location**: docs/for-ai/
...
**Creating a component?** → implementation/raw-eds-blocks-guide.md OR complex-eds-blocks-guide.md
**Testing?** → testing/eds-native-testing-standards.md
**Debugging?** → testing/debug.md
**Architecture decisions?** → implementation/design-philosophy-guide.md
**Security?** → guidelines/security-checklist.md

Ask the user: "What aspect of EDS development would you like to explore?" Then provide specific guidance based on their answer.
