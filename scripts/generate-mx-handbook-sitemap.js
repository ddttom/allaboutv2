...
const RULES = {
  ...
  'the-mx-handbook.pdf': { priority: 1.0, changefreq: 'monthly' },
};
 ...
 * @file generate-mx-handbook-sitemap.js
 * @version 1.0
...
function main() {
  // eslint-disable-next-line no-console
  console.log('🗺️  Generating sitemap for mx-handbook folder...\n');
  ...
  if (files.length === 0) {
    // eslint-disable-next-line no-console
    console.log('⚠️  No HTML or PDF files found in mx-handbook folder');
    return;
  }
