...
**MX-Hub** is the monorepo for CogNovaMX Ltd. It contains everything: Canon (the single source of truth), the Maxine app, the cog registry, the book manuscripts, the web audit suite, and the operational brain of the gestalt.
