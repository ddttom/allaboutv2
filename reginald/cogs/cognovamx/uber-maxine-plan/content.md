...
- **Three demo profiles**: Base Tom (enriched with professional, technology, content-systems tags), wheelchair-user (step-free, accessible-parking, lift-access, mobility priority), consultant (speaker, CMS expert, CogNovaMX, digital transformation).
