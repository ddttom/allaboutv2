...
|---------------------|-----------------------------|-------|
| **CogNovaMX** | `mxtechnologies.tech`*      | Future corporate home, neutral and trust-first |
...
| `cognovamx.ai`     | Redirect     | `https://mxtechnologies.tech/`      | Hyphen variant → canonical |
...
- prepares CogNovaMX for `.tech` or `.systems`
