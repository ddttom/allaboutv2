...
- **MX: The Codex** — comprehensive reference work
...
1. **Universal** — same settings in all metadata.yaml files (Handbook, Codex, case studies)
...
All MX publications represent the same brand and quality level. Readers expect consistent typography whether reading the Handbook, Codex, or a case study. Universal standards ensure this.
...
One decision covers all publications. Handbook, Codex, case studies, future books — all benefit immediately.
...
3. **Update all book metadata.yaml files:**
   ...
   - Codex: `datalake/assets/configs/books/codex/metadata.yaml`
...
4. **Regenerate PDFs to verify:**
   ...
   npm run pdf:codex-generate   # Codex
   ```
...
- ⏳ Codex metadata.yaml pending update
- ⏳ Case studies metadata.yaml pending update

**Next Actions:**

1. Apply typography settings to Codex metadata.yaml
2. Apply typography settings to case studies metadata.yaml
3. Add needspace usage to Handbook/Codex content where needed
