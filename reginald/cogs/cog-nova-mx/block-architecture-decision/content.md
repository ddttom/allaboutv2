...
- **Affects** The Handbook (2 Apr) and The Codex (1 Jul)
...
**Cog-Nova-MX Ltd** builds and sells Maxine — the reference implementation. Commercial.

**The Gathering** owns the open standard. Uncontrolled by Cog-Nova-MX. Tom set it up. He wants to give the techniques away. A truly open community takes it forward. The W3C model.
