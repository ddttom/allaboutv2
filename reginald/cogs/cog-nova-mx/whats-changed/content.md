    ...
    - name: list
      ...
      usage: |
        ...
        4. Present results as a table sorted by modification date (newest first):
           ...
           | MODIFIED | md | The Principles That Changed... | published | content-lifecycle/4-ready-to-... | 2026-02-11 |
    ...
    - name: gaps
      ...
      usage: |
        ...
        4. Present as a table sorted by score (worst first):
           ...
           |-------|---------------|------|
           | 0/5 | no frontmatter | content-lifecycle/1-raw-ideas/meeting.md |
...
- **Subdirectory scoping** — focus on mx-canon, content-lifecycle, or any subdirectory
