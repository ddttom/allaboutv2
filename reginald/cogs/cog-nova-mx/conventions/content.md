...
| Content | Location | Notes |
|---------|----------|-------|
| Codex PDFs | `mx-outputs/pdf/books/codex/` | PDF, Kindle, simple formats |
| Codex HTML | `mx-outputs/html/books/codex/` | Standalone HTML for print |
...
| Blog HTML (other) | `communications/blogs/html/{codex,outputs,lifecycle}/` | By provenance |
