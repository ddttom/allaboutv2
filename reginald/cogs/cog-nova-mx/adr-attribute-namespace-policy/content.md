...
> - **Cog-Nova-MX (vendor):** [vendor-extensions-policy.cog.md](../../MX-Maxine-Lives/registers/ADR/vendor-extensions-policy.cog.md)
>
...
**Important:** The `mx:` namespace belongs to **The Gathering**, not Cog-Nova-MX. This is a common source of confusion.
...
| `x-mx-` | Cog-Nova-MX | Vendor extension (public) | `x-mx-audience-segment` |
| `x-mx-p-` | Cog-Nova-MX | Vendor extension (private) | `x-mx-p-ref` |

**The distinction:**

- Standard vocabularies use namespace prefixes (`dc:` for Dublin Core, `og:` for Open Graph, `mx:` for MX)
- Vendor extensions use `x-` prefixes (`x-webkit-` for Safari, `x-mx-` for Cog-Nova-MX)
