...
name: pdf-generator
version: "1.10.0"
description: "Generate professional PDFs from markdown — professional table formatting with alternating row colors, improved ASCII diagram rendering with samepage protection, emoji cleanup, invisible Unicode removal (zero-width spaces), automatic illustration generation with aspect ratio preservation, auto-scaled images, A4 and Kindle formats. Uses pandoc's pygments syntax highlighting for searchable, colored code blocks. Includes widow/orphan prevention, intelligent page break control, and task list extension handling."
    ...
    - name: generate
      ...
      usage: |
        ...
        **Color definitions:**
        ...
        \definecolor{tableeven}{HTML}{F9F9F9}
        ```
        ...
        **Alternating row colors:**
        ...
        \renewenvironment{longtable}{\rowcolors{2}{tableodd}{tableeven}\oldlongtable}{\endoldlongtable}
        ```
        ...
        **Example markdown table:**
        ...
        - Professional top/middle/bottom rules
        ...
        **LaTeX settings required:**
        ...
        \widowpenalty=10000         # Prevent widows (orphaned line at top of page)
        \clubpenalty=10000          # Prevent orphans (orphaned line at bottom of page)
        ...
        **What these settings do:**
        ...
        3. **Flexible page bottoms (`\raggedbottom`):**
           ...
           - Works with widow/orphan prevention by giving LaTeX flexibility
