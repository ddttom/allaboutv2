...
const handleRequest = async (request, env, _ctx) => {
  ...
  // PORT REDIRECT DISABLED FOR LOCAL TESTING
  // In production, this redirects non-standard ports to default port
  // Commented out for local dev server testing on port 8787
  /*
  if (url.port) {
