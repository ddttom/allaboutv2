...
echo ""
echo "  1. RECOMMENDED: Clean metadata"
echo "     Use: | jsonld | article |"
echo "     Generates: <meta name=\"jsonld\" content=\"article\">"
echo ""
echo "  2. Legacy: json-ld metadata"
echo "     Use: | json-ld | article |"
echo "     (Supported for existing pages)"
echo ""
echo "  3. Future-proofing: Existing JSON-LD scripts"
echo "     <script type=\"application/ld+json\">{...}</script>"
echo "     (Worker regenerates from fresh metadata)"
echo ""
