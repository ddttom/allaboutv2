#!/bin/bash
# Response Comparison Tool for Cloudflare Worker
# Shows before/after comparison of worker transformations
...
ORIGIN_URL="https://main--allaboutv2--ddttom.aem.page"

echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BOLD}${BLUE}    Cloudflare Worker Before/After Comparison${NC}"
echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
TEST_PAGE="/blogs/ddt/ai/aem-sidekick-copilot"
if [ ! -z "$1" ]; then
    TEST_PAGE="$1"
fi
...
echo -e "${GREEN}✓ Worker response saved${NC}"
echo ""
