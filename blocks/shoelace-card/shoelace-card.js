 ...
 */
const K = globalThis; const gt = K.ShadowRoot && (K.ShadyCSS === void 0 || K.ShadyCSS.nativeShadow) && 'adoptedStyleSheets' in Document.prototype && 'replace' in CSSStyleSheet.prototype; const vt = Symbol(); const
...
const ie = (e) => new Ft(typeof e === 'string' ? e : `${e}`, void 0, vt); const z = (e, ...t) => {
  ...
  if (gt) e.adoptedStyleSheets = t.map((o) => (o instanceof CSSStyleSheet ? o : o.styleSheet));
    ...
    for (const o of t) {
      const r = document.createElement('style'); const
        s = K.litNonce;
 ...
 */
const {
  is: ce, defineProperty: de, getOwnPropertyDescriptor: ue, getOwnPropertyNames: he, getOwnPropertySymbols: pe, getPrototypeOf: me,
} = Object; const $ = globalThis; const zt = $.trustedTypes; const be = zt ? zt.emptyScript : ''; const fe = $.reactiveElementPolyfillSupport; const D = (e, t) => e; const ot = {
  toAttribute(e, t) {
    switch (t) {
      case Boolean:
        e = e ? be : null;
...
}; const yt = (e, t) => !ce(e, t); const
  Pt = {
    attribute: !0, type: String, converter: ot, reflect: !1, useDefault: !1, hasChanged: yt,
  };
...
const P = class extends HTMLElement {
  ...
  static createProperty(t, o = Pt) {
    if (o.state && (o.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((o = Object.create(o)).wrapped = !0), this.elementProperties.set(t, o), !o.noAccessor) {
      const r = Symbol(); const
        s = this.getPropertyDescriptor(t, r, o);
      s !== void 0 && de(this.prototype, t, s);
    }
  }

  static getPropertyDescriptor(t, o, r) {
    const { get: s, set: l } = ue(this.prototype, t) ?? {
      get() {
        return this[o];
      },
      set(a) {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this.*$Ei(), this.hasOwnProperty(D('properties'))) {
      const o = this.properties; const
        r = [...he(o), ...pe(o)];
  ...
  constructor() {
    super(), this.*$Ep = void 0, this.isUpdatePending = !1, this.hasUpdated = !1, this._$Em = null, this.*$Ev();
  }

  *$Ev() {
    this._$ES = new Promise((t) => this.enableUpdating = t), this.*$AL = /* @__PURE__ */ new Map(), this._$E_(), this.requestUpdate(), this.constructor.l?.forEach((t) => t(this));
  }
  ...
  _$E_() {
    const t = /* @__PURE__ */ new Map(); const
  ...
  *$ET(t, o) {
    const r = this.constructor.elementProperties.get(t); const
      s = this.constructor._$Eu(t, r);
    if (s !== void 0 && r.reflect === !0) {
      const l = (r.converter?.toAttribute !== void 0 ? r.converter : ot).toAttribute(o, r.type);
      this.*$Em = t, l == null ? this.removeAttribute(s) : this.setAttribute(s, l), this._$Em = null;
    }
  }

  *$AK(t, o) {
    const r = this.constructor; const
      s = r._$Eh.get(t);
    if (s !== void 0 && this.*$Em !== s) {
      const l = r.getPropertyOptions(s); const
        a = typeof l.converter === 'function' ? { fromAttribute: l.converter } : l.converter?.fromAttribute !== void 0 ? l.converter : ot;
  ...
  requestUpdate(t, o, r) {
    if (t !== void 0) {
      const s = this.constructor; const
        l = this[t];
      if (r ?? (r = s.getPropertyOptions(t)), !((r.hasChanged ?? yt)(l, o) || r.useDefault && r.reflect && l === this.*$Ej?.get(t) && !this.hasAttribute(s._$Eu(t, r)))) return;
      this.C(t, o, r);
    }
    this.isUpdatePending === !1 && (this.*$ES = this._$EP());
  }

  C(t, o, { useDefault: r, reflect: s, wrapped: l }, a) {
    r && !(this.*$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(t) && (this.*$Ej.set(t, a ?? o ?? this[t]), l !== !0 || a !== void 0) || (this._$AL.has(t) || (this.hasUpdated || r || (o = void 0), this.*$AL.set(t, o)), s === !0 && this._$Em !== t && (this.*$Eq ?? (this._$Eq = /*@__PURE__*/ new Set())).add(t));
  }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      if (this.renderRoot ?? (this.renderRoot = this.createRenderRoot()), this.*$Ep) {
    ...
    const o = this.*$AL;
    try {
      t = this.shouldUpdate(o), t ? (this.willUpdate(o), this._$EO?.forEach((r) => r.hostUpdate?.()), this.update(o)) : this.*$EM();
    } catch (r) {
  ...
  update(t) {
    this.*$Eq && (this._$Eq = this.*$Eq.forEach((o) => this._$ET(o, this[o]))), this._$EM();
  }
...
* SPDX-License-Identifier: BSD-3-Clause
 */
const R = globalThis; const rt = R.trustedTypes; const Lt = rt ? rt.createPolicy('lit-html', { createHTML: (e) => e }) : void 0; const jt = '$lit$'; const x = `lit$${Math.random().toFixed(9).slice(2)}$`; const qt = `?${x}`; const ge = `<${qt}>`; const E = document; const F = () => E.createComment(''); const j = (e) => e === null || typeof e !== 'object' && typeof e !== 'function'; const wt = Array.isArray; const ve = (e) => wt(e) || typeof e?.[Symbol.iterator] === 'function'; const nt = `[  
\f\r]`; const I = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g; const Mt = /-->/g; const Tt = />/g; const k = RegExp(`>|${nt}(?:([^\\s"'>=/]+)(${nt}*=${nt}*(?:[^  
\f\r"'\`<>=]|("|')|))|$)`, 'g'); const It = /'/g; const Ot = /"/g; const Wt = /^(?:script|style|textarea|title)$/i; const ye = (e) => (t, ...o) => ({ _$litType$: e, strings: t, values: o }); const W = ye(1); const S = Symbol.for('lit-noChange'); const f = Symbol.for('lit-nothing'); const Bt = /* @__PURE__ */ new WeakMap(); const
  A = E.createTreeWalker(E, 129);
function Zt(e, t) {
  if (!wt(e) || !e.hasOwnProperty('raw')) throw Error('invalid template strings array');
  return Lt !== void 0 ? Lt.createHTML(t) : t;
}
const we = (e, t) => {
  const o = e.length - 1; const
    r = [];
  let s; let l = t === 2 ? '<svg>' : t === 3 ? '<math>' : ''; let
    a = I;
  for (let n = 0; n < o; n++) {
    const i = e[n];
    let u; let m; let h = -1; let
      w = 0;
...
class q {
  constructor({ strings: t, _$litType$: o }, r) {
    ...
    let l = 0; let
      a = 0;
    const n = t.length - 1; const i = this.parts; const
      [u, m] = we(t, o);
      ...
      if (s.nodeType === 1) {
        if (s.hasAttributes()) {
          for (const h of s.getAttributeNames()) {
            if (h.endsWith(jt)) {
              const w = m[a++]; const _ = s.getAttribute(h).split(x); const
                Q = /([.?@])?(.*)/.exec(w);
              i.push({
                type: 1, index: l, name: Q[2], strings: _, ctor: Q[1] === '.' ? xe : Q[1] === '?' ? $e : Q[1] === '@' ? ke : lt,
              }), s.removeAttribute(h);
            } else h.startsWith(x) && (i.push({ type: 6, index: l }), s.removeAttribute(h));
          }
        }
        if (Wt.test(s.tagName)) {
          const h = s.textContent.split(x); const
            w = h.length - 1;
          if (w > 0) {
            s.textContent = rt ? rt.emptyScript : '';
            for (let_ = 0; _ < w; *++) s.append(h[*], F()), A.nextNode(), i.push({ type: 2, index: ++l });
            s.append(h[w], F());
          }
        }
      } else if (s.nodeType === 8) {
        if (s.data === qt) i.push({ type: 2, index: l });
        else {
          let h = -1;
...
function M(e, t, o = e, r) {
  if (t === S) return t;
  let s = r !== void 0 ? o.*$Co?.[r] : o._$Cl;
  const l = j(t) ? void 0 : t.*$litDirective$;
  return s?.constructor !== l && (s?.*$AO?.(!1), l === void 0 ? s = void 0 : (s = new l(e), s._$AT(e, o, r)), r !== void 0 ? (o.*$Co ?? (o._$Co = []))[r] = s : o.*$Cl = s), s !== void 0 && (t = M(e, s._$AS(e, t.values), s, r)), t;
}
class *e {
  constructor(t, o) {
    this.*$AV = [], this._$AN = void 0, this.*$AD = t, this._$AM = o;
  }
  ...
  u(t) {
    const { el: { content: o }, parts: r } = this._$AD; const
      s = (t?.creationScope ?? E).importNode(o, !0);
    A.currentNode = s;
    let l = A.nextNode(); let a = 0; let n = 0; let
      i = r[0];
    for (; i !== void 0;) {
      if (a === i.index) {
        let u;
  ...
  p(t) {
    let o = 0;
    for (const r of this.*$AV) r !== void 0 && (r.strings !== void 0 ? (r._$AI(t, r, o), o += r.strings.length - 2) : r.*$AI(t[o])), o++;
  }
}
class Z {
  get _$AU() {
    return this.*$AM?._$AU ?? this.*$Cv;
  }

  constructor(t, o, r, s) {
    this.type = 2, this.*$AH = f, this._$AN = void 0, this.*$AA = t, this._$AB = o, this._$AM = r, this.options = s, this._$Cv = s?.isConnected ?? !0;
  }
  ...
  *$AI(t, o = this) {
    t = M(this, t, o), j(t) ? t === f || t == null || t === '' ? (this._$AH !== f && this.*$AR(), this._$AH = f) : t !== this.*$AH && t !== S && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ve(t) ? this.k(t) : this.*(t);
  }
  ...
  T(t) {
    this.*$AH !== t && (this._$AR(), this.*$AH = this.O(t));
  }

  *(t) {
    this.*$AH !== f && j(this._$AH) ? this._$AA.nextSibling.data = t : this.T(E.createTextNode(t)), this._$AH = t;
  }

  $(t) {
    const { values: o, _$litType$: r } = t; const
      s = typeof r === 'number' ? this._$AC(t) : (r.el === void 0 && (r.el = q.createElement(Zt(r.h, r.h[0]), this.options)), r);
    if (this.*$AH?._$AD === s) this.*$AH.p(o);
    else {
      const l = new _e(s, this); const
        a = l.u(this.options);
  ...
  k(t) {
    wt(this.*$AH) || (this._$AH = [], this.*$AR());
    const o = this._$AH;
    let r; let
      s = 0;
    for (const l of t) s === o.length ? o.push(r = new Z(this.O(F()), this.O(F()), this, this.options)) : r = o[s], r.*$AI(l), s++;
    s < o.length && (this._$AR(r && r.*$AB.nextSibling, s), o.length = s);
  }

  *$AR(t = this._$AA.nextSibling, o) {
    for (this.*$AP?.(!1, !0, o); t && t !== this._$AB;) {
  ...
  setConnected(t) {
    this.*$AM === void 0 && (this._$Cv = t, this.*$AP?.(t));
  }
}
class lt {
  get tagName() {
  ...
  constructor(t, o, r, s, l) {
    this.type = 1, this.*$AH = f, this._$AN = void 0, this.element = t, this.name = o, this.*$AM = s, this.options = l, r.length > 2 || r[0] !== '' || r[1] !== '' ? (this._$AH = Array(r.length - 1).fill(new String()), this.strings = r) : this._$AH = f;
  }

  *$AI(t, o = this, r, s) {
    const l = this.strings;
    let a = !1;
    if (l === void 0) t = M(this, t, o, 0), a = !j(t) || t !== this._$AH && t !== S, a && (this.*$AH = t);
    else {
      const n = t;
      let i; let
        u;
...
class ke extends lt {
  ...
  *$AI(t, o = this) {
    ...
    const r = this._$AH; const s = t === f && r !== f || t.capture !== r.capture || t.once !== r.once || t.passive !== r.passive; const
      l = t !== f && (r === f || s);
    s && this.element.removeEventListener(this.name, this, r), l && this.element.addEventListener(this.name, this, t), this.*$AH = t;
  }

  handleEvent(t) {
    typeof this.*$AH === 'function' ? this._$AH.call(this.options?.host ?? this.element, t) : this.*$AH.handleEvent(t);
  }
}
class Ce {
  constructor(t, o, r) {
...
`; const Yt = Object.defineProperty; const Pe = Object.defineProperties; const Le = Object.getOwnPropertyDescriptor; const Me = Object.getOwnPropertyDescriptors; const Nt = Object.getOwnPropertySymbols; const Te = Object.prototype.hasOwnProperty; const Ie = Object.prototype.propertyIsEnumerable; const Qt = (e) => {
  throw TypeError(e);
}; const Ut = (e, t, o) => (t in e ? Yt(e, t, {
  enumerable: !0, configurable: !0, writable: !0, value: o,
}) : e[t] = o); const G = (e, t) => {
  for (var o in t || (t = {})) Te.call(t, o) && Ut(e, o, t[o]);
  if (Nt) for (var o of Nt(t)) Ie.call(t, o) && Ut(e, o, t[o]);
  return e;
}; const Xt = (e, t) => Pe(e, Me(t)); const c = (e, t, o, r) => {
  for (var s = r > 1 ? void 0 : r ? Le(t, o) : t, l = e.length - 1, a; l >= 0; l--) (a = e[l]) && (s = (r ? a(t, o, s) : a(s)) || s);
  return r && s && Yt(t, o, s), s;
}; const Jt = (e, t, o) => t.has(e) || Qt(`Cannot ${o}`); const Oe = (e, t, o) => (Jt(e, t, 'read from private field'), t.get(e)); const Be = (e, t, o) => (t.has(e) ? Qt('Cannot add the same private member more than once') : t instanceof WeakSet ? t.add(e) : t.set(e, o)); const
  Ne = (e, t, o, r) => (Jt(e, t, 'write to private field'), t.set(e, o), o);
/**
 ...
 */
const Ue = {
  attribute: !0, type: String, converter: ot, reflect: !1, hasChanged: yt,
}; const
  De = (e = Ue, t, o) => {
...
* SPDX-License-Identifier: BSD-3-Clause
 */
const Ve = { ATTRIBUTE: 1 }; const
  He = (e) => (...t) => ({ _$litDirective$: e, values: t });
const Fe = class {
  constructor(t) {
  }
  ...
  *$AT(t, o, r) {
    this._$Ct = t, this.*$AM = o, this._$Ci = r;
  }
...
`;
const mt = /*@__PURE__ */ new Set(); const
  L = /* @__PURE__*/ new Map();
let C; let _t = 'ltr'; let
  xt = 'en';
...
function oe(...e) {
  e.map((t) => {
    ...
    L.has(o) ? L.set(o, { ...L.get(o), ...t }) : L.set(o, t), C || (C = t);
  }), re();
}
function re() {
...
const qe = class {
  ...
  getTranslationData(t) {
    let o; let
      r;
    const s = new Intl.Locale(t.replace(/_/g, '-')); const l = s?.language.toLowerCase(); const a = (r = (o = s?.region) === null || o === void 0 ? void 0 : o.toLowerCase()) !== null && r !== void 0 ? r : ''; const n = L.get(`${l}-${a}`); const
      i = L.get(l);
    return {
      locale: s, language: l, region: a, primary: n, secondary: i,
    };
  }
  ...
  exists(t, o) {
    ...
    return o = { includeFallback: !1, ...o }, !!(s && s[t] || l && l[t] || o.includeFallback && C && C[t]);
  }
...
$t.styles = [T, je];
const O = /* @__PURE__ */ new WeakMap(); const B = /* @__PURE__ */ new WeakMap(); const N = /* @__PURE__ */ new WeakMap(); const ct = /* @__PURE__ */ new WeakSet(); const X = /* @__PURE__ */ new WeakMap(); const Ze = class {
  constructor(e, t) {
    this.handleFormData = (o) => {
      const r = this.options.disabled(this.host); const s = this.options.name(this.host); const l = this.options.value(this.host); const
      ...
      let r;
      const s = this.options.disabled(this.host); const
        l = this.options.reportValidity;
      ...
      if (this.form && !this.form.noValidate) {
        ...
        for (const r of o) if (typeof r.checkValidity === 'function' && !r.checkValidity()) return !1;
      }
      return !0;
    }, this.reportFormValidity = () => {
      if (this.form && !this.form.noValidate) {
        const o = this.form.querySelectorAll('*');
        for (const r of o) if (typeof r.reportValidity === 'function' && !r.reportValidity()) return !1;
      }
      return !0;
...
* the host element immediately, i.e. before Lit updates the component in the next update.
   */
  setValidity(e) {
    const t = this.host; const o = !!ct.has(t); const
      r = !!t.required;
...
function Ye(e = '') {
  if (!bt) {
    const t = [...document.getElementsByTagName('script')]; const
      o = t.find((r) => r.hasAttribute('data-shoelace'));
    if (o) Dt(o.getAttribute('data-shoelace'));
    else {
...
function Ct(e, t) {
  ...
  return (r, s) => {
    const { update: l } = r; const
      a = Array.isArray(e) ? e : [e];
    r.update = function (n) {
      a.forEach((i) => {
        const u = i;
        if (n.has(u)) {
          const m = n.get(u); const
            h = this[u];
...
const U = Symbol(); const J = Symbol(); let dt; const ut = /* @__PURE__ */ new Map(); const
  y = class extends v {
    constructor() {
    ...
    async setIcon() {
      let e;
      const { url: t, fromLibrary: o } = this.getIconSource(); const
        r = o ? Vt(this.library) : void 0;
      if (!t) {
        this.svg = null;
        return;
      }
      let s = ut.get(t);
      if (s || (s = this.resolveIcon(t, r), ut.set(t, s)), !this.initialRender) return;
      const l = await s;
...
* SPDX-License-Identifier: BSD-3-Clause
 */
const ae = Symbol.for(''); const lo = (e) => {
  if (e?.r === ae) return e?.*$litStatic$;
}; const st = (e, ...t) => ({
  *$litStatic$: t.reduce((o, r, s) => o + ((l) => {
    if (l.*$litStatic$ !== void 0) return l.*$litStatic$;
  ...
  r: ae,
}); const Ht = /* @__PURE__ */ new Map(); const ao = (e) => (t, ...o) => {
  const r = o.length;
  let s; let
    l;
  const a = []; const
...
async function mo(e, t = 2) {
  for (let o = 1; o <= t; o++) {
    try {
      ...
      if (!Array.isArray(l)) throw new Error('Invalid data format: expected array');
      return l;
    } catch (r) {
      if (o === t) throw r;
...
function _o(e) {
  ...
  if (t) {
    e.preventDefault();
    const o = t.dataset.cardPath; const
      r = t.dataset.cardImage;
    xo(o, r);
  }
}
...
async function $o(e, t) {
  try {
    ...
    const a = l.querySelector('h1'); const
      n = a ? a.textContent : 'Details';
    a && a.remove();
...
async function Co() {
  ...
  for (const t of e) {
    let o = 0;
    for (; !customElements.get(t) && o < 50;) await new Promise((r) => setTimeout(r, 20)), o++;
    if (!customElements.get(t)) throw new Error(`Component ${t} failed to load`);
  }
}
async function Ao(e) {
  const t = document.createElement('div');
...
async function Mo(e) {
  try {
    ...
    const r = await Ao(o); const s = e.getAttribute('data-block-status'); const l = e.getAttribute('data-block-name'); const
      a = Array.from(e.classList);
