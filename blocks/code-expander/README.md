...
- `.code-expander-wrapper`: Wraps the entire component (copy button and code) but is not visible
...
- The original appearance of the code is preserved.
...
6. Allow customization of the button's appearance.
