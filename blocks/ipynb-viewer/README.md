...
mx:
  status: active
  canonicalUri: https://raw.githubusercontent.com/ddttom/allaboutv2/main/blocks/ipynb-viewer/README.md
---
...
- splash-page - URL of splash screen image to display during initialization and when home button is pressed (e.g., "https://example.com/splash.png")
  ...
  - **Display duration:**
    - **Startup:** 7.5 seconds minimum (can be closed early with X button)
    - **Home button:** 5 seconds minimum (can be closed early with X button)
  - **When shown:**
