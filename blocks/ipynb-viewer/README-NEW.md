...
**Enhanced Markdown Rendering** - Full support for tables, code blocks, lists, blockquotes, and inline formatting.
...
1. Start the development server: npm run debug
2. Access the test file: http://localhost:3000/blocks/ipynb-viewer/test.html
...
See EDS Block Development, Jupyter Notebook Testing, and EDS Native Testing.
