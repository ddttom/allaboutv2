...
description: "Usage examples for the search EDS block"
...
mx:
  status: active
  canonicalUri: https://raw.githubusercontent.com/ddttom/allaboutv2/main/blocks/search/EXAMPLE.md
---

# Search Block Examples
...
## Search with Custom Data Source

| Search |
|--------|
| /blog/query-index.json |

## Search with External Data Source
...
|---------|
| ## Search Our Site |
| Find articles, guides, and resources quickly |
